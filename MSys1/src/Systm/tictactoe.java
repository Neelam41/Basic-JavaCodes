package Systm;
	...
	public class tictactoe {
			...
			case 2:
			 ...
			 System.out.print("Player2's name:");
			  ...
			  while(a) {
				...
				placepiece(car,pos,symbol1);
				ZZ(car,symbol1,player1);
				System.out.println(player2+"'s chance--"+symbol2);
				System.out.print("enter position(1-9)") ;
				int pos1 = sc.nextInt();
				placepiece(car,pos1,symbol2);
				ZZ(car,symbol2,player2);
				  gameboard(car);         
		...
		public static void game(char[][]g) {
			for(char[]R:g) {
				for(char z:R) {
					if(z==' ') {
						System.out.print(no);
		...
		public static void ZZ(char[][] car,char symbol,String player) {
